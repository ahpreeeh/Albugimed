...
| Lot | Étapes | Ce qu'il contient | Risque | Smoke |
|---|---|---|---|---|
| **AF** | 7.1 ✅ / 7.2 → 7.3 ⏳ | Extraire `DayLoadSelector`, `DifficultySelector`, `SessionTimer` depuis `SessionWidget.tsx` vers `features/session-widget/`. `DayLoadSelector` extrait, tests/build OK. | faible | regroupable |
